...
$(".countrymap").on("mouseover", function () {
      $('#storyContent').animate({scrollTop: $("#articleMap").offset().top-60},'slow');
  });
...
function appendmap(id,countryname){
  d3.json("data/uscountywithname.json", function(error, us) {
    ...
    g.on("mouseover", function () {
      $('#storyContent').animate({scrollTop: $("#articleCountryMaps").offset().top-60},'fast');
...
//advanced
  ...
  svg.selectAll("rect[style = 'fill: steelblue;']")
      .on("mouseover", function(d) {
        $('#storyContent').animate({scrollTop: $("#articleDegree").offset().top-60},'fast');
...
d3.csv("data/countrySalary.csv", function(error, data) {
  ...
  svg.selectAll(".salarybar")
    ...
    .enter().append("rect")
      ...
      .on("mouseover", function(d) {
        $('#storyContent').animate({scrollTop: $("#articleIncome").offset().top-60},'fast');
        d3.select(this).style("fill", "#b46e46");
        var sentenceList = []
        for (var key in sentenceInfo){
...
d3.csv("data/countryCitizen.csv", function(error, data) {
  ...
  svg.selectAll(".citizenbar")
    ...
    .enter().append("rect")
      ...
      .attr("height", y.bandwidth())
      .on("mouseover", function(d) {
        $('#storyContent').animate({scrollTop: $("#articleCitizen").offset().top-60},'fast');
        d3.select(this).style("fill", "#b46e46");
        var sentenceList = []
        for (var key in sentenceInfo){
...
d3.csv("data/countryArrival.csv", function(error, data) {
  ...
  g.append("g")
    ...
    .enter().append("rect")
      ...
      .attr("fill", "steelblue")
      .on("mouseover", function(d) {
        $('#storyContent').animate({scrollTop: $("#articleArrival").offset().top-60},'fast');
        d3.select(this).style("fill", "#b46e46");
        var sentenceList = []
        for (var key in sentenceInfo){
